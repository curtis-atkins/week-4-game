$(document).ready(function() {
	...
	//update the value of variable "randNumber" so that it is centered and has a font size of 100px
	$("#randomNumber").css({"font-size":"100px","text-align":"center"});
	...
	//show red gem count after each click
		console.log(redGemCounter);
